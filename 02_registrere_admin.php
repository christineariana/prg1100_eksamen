...
<table class="center">
        <tr>
                ...
                <tr>
                        <td>Hotellnavn </td>
                        <td><input name="hotellnavn" type="text" id="hotellnavn"  > </td> <br />
                </tr>
                <tr>
                        <td>Stillingstittel </td>
                        <td><input name="stilling" type="text" id="stilling"  > </td> <br />
                </tr>
                <tr>
                        <td>Passord </td>
...
if (isset($_POST ["registrerBrukerKnapp"])){
    ...
    $RegStilling=$_POST["stilling"]; 
    $RegPassord=$_POST["passord"]; 
    
    if (!$RegBrukernavn || !$RegFornavn || !$RegEtternavn || !$RegHotell || !$RegStilling || !$RegPassord) {
        ...
        $sqlSetning="SELECT * FROM adminbruker WHERE bruker ='$RegBrukernavn';";
    ...
    if (mysqli_num_rows($sqlResultat)!=0)  /* brukernavnet er registrert fra før */{
        ...
        $sqlSetning="INSERT INTO adminbruker VALUES ('$RegBrukernavn','$RegFornavn','$RegEtternavn','$RegHotell','$RegStilling','$RegPassord');";
        ...
        print ("<a href='innlogg_admin.php'>Gå til innloggingsside </a>");}}}
