...
<header>
<h1> Logg inn som administrator </h1>
</header>
...
<a href="02_registrere_admin.php">Registrer adminbruker her</a> <br /> <br />
...
if (isset($_POST ["logginnKnapp"])){
    ...
    if (!sjekkBrukernavnPassord($brukernavn,$passord))  /* brukernavn og passord er ikke korrekt */{
        ...
        print("<meta http-equiv='refresh' content='0;url=02_endre_hotell.php'>");/* redirigering til hoved-siden (hoved.php) */
        }
}
...
function sjekkBrukernavnPassord($brukernavn,$passord){
    ...
    $lovligBruker=true;
    $sqlSetning="SELECT * FROM adminbruker WHERE bruker = '$brukernavn';";
